--
-- Copyright © 2016-2022 The hilongit Authors
--
...
CREATE TABLE IF NOT EXISTS protocol (
    "id" uuid NOT NULL CONSTRAINT protocol_pkey PRIMARY KEY,
...
COMMENT ON COLUMN "public"."protocol"."name" IS '名称';
COMMENT ON COLUMN "public"."protocol"."type" IS '类型';
COMMENT ON COLUMN "public"."protocol"."tenant_id" IS '所属租户id';
COMMENT ON COLUMN "public"."protocol"."description" IS '描述';
COMMENT ON COLUMN "public"."protocol"."search_text" IS '搜索文本';
COMMENT ON COLUMN "public"."protocol"."data" IS '协议文件二进制';
COMMENT ON COLUMN "public"."protocol"."status" IS '协议状态';
...
CREATE TABLE IF NOT EXISTS "opc_ua_client_device" (
  "id" uuid NOT NULL CONSTRAINT client_device_pkey PRIMARY KEY,
  "client_id" uuid,
  "device_id" uuid,
  "tenant_id" uuid,
  "created_time" int8,
...
-- ----------------------------
-- Table structure for opc_ua_client_device_point
-- ----------------------------
CREATE TABLE IF NOT EXISTS "opc_ua_client_device_point" (
  "id" uuid NOT NULL CONSTRAINT point_pkey PRIMARY KEY,
  "client_device_id" uuid,
  "name" varchar(255) COLLATE "pg_catalog"."default",
  "point_value" varchar(255) COLLATE "pg_catalog"."default",
  "attribute_key" varchar(255) COLLATE "pg_catalog"."default",
  "data_type" varchar(255) COLLATE "pg_catalog"."default",
  "data_mode" varchar(255) COLLATE "pg_catalog"."default",
  "tenant_id" uuid,
  "created_time" int8,
  "interval" int2,
  "description" varchar(255),
...
(
    ...
    CONSTRAINT attribute_kv_pkey PRIMARY KEY
(
    entity_type,
    entity_id,
    attribute_type,
